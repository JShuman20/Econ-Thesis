...
#Writing a Restricted Dataset to characterize some votes
ALL_LCV_SENATE_MERGE %>%
  filter(Year %in% c(1990, 2008,2010,2016,2018)) %>%
  distinct(OTHER) %>%
  write_xlsx(., path = "~/Desktop/Test_Vote_Characterizations.xlsx")
